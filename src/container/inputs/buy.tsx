  ...
  return (
    <div>
      <div className='buy-container'>
        <div className="buy-inputs-section">
          <div className='buy-col'>
            <div className='buy-sub-title'>Launch Periodic</div>
          ...
          <div className='buy-col'>
            <div className='buy-sub-title'>Relaunch after SL</div>
            <InputChild label="on/off" type="warning" disabled={false} defaultValue="1"/>
          ...
          <div className='buy-col'>
            <div className='buy-sub-title'>Buy the dip</div>
            <InputChild label="on/off" type="warning" disabled={false} defaultValue="1"/>
            <InputChild label="Avg RSI Avg Time Period" type="success" disabled={true} defaultValue="5"/>
